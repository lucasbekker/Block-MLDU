...
function [ L_MXs, D_MXs, U_MXs ] = MLDU_test3( A, block_sizes )
...
in_L = 1:L.nz; in_D = 1:D.nz; in_U = 1:U.nz;

% Extract actual values and store them in the MATLAB sparse datatype.
L_MXs = sparse(L.i(in_L),L.j(in_L),L.v(in_L),L.m,L.n);
D_MXs = sparse(D.i(in_D),D.j(in_D),D.v(in_D),D.m,D.n);
U_MXs = sparse(U.i(in_U),U.j(in_U),U.v(in_U),U.m,U.n);
